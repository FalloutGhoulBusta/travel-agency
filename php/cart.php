...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) === 'xmlhttprequest') {
    ...
    echo json_encode(['html' => $cartHtml]);
    exit;
}
?>
<!DOCTYPE html>
    ...
    <script>
        ...
        function updateCart() {
            ...
            .then(data => {
                ...
                if (!modalOpen) {
                    ...
                    const modalBtn = document.querySelector('[data-bs-target="#bookingModal"]');
                    if (modalBtn) {
        ...
        if (bookingModal) {
            ...
            bookingModal.addEventListener('hidden.bs.modal', () => {
                updateCart(); // Immediate refresh when closing
                cartInterval = setInterval(updateCart, 5000);
            });
        }
